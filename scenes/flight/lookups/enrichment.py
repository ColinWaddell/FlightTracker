...
from scenes.flight.lookups.results import FlightObservation, LookupContext, RouteInfo
...
def enrich(observation: FlightObservation) -> RouteInfo:
    ...
    """
    from scenes.flight.lookups import aircraft as aircraft_service
    from scenes.flight.lookups import routes as route_service
