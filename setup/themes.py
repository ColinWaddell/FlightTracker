...
# Conditions theme
THEME_CONDITIONS_TIME = "CONDITIONS_TIME"
THEME_CONDITIONS_DATE = "CONDITIONS_DATE"
THEME_CONDITIONS_DAY = "CONDITIONS_DAY"
THEME_CONDITIONS_HUMIDITY = "CONDITIONS_HUMIDITY"
THEME_CONDITIONS_WIND = "CONDITIONS_WIND"
THEME_CONDITIONS_SUNRISE = "CONDITIONS_SUNRISE"
THEME_CONDITIONS_SUNSET = "CONDITIONS_SUNSET"
THEME_CONDITIONS_DESCRIPTION = "CONDITIONS_DESCRIPTION"
...
THEME_DEFAULT = {
    ...
    THEME_AIRLINE: colours.WAX_YELLOW,
    ...
    THEME_CONDITIONS_TIME: colours.BLUE_CALM,
    THEME_CONDITIONS_DATE: colours.DARKER_PINK,
    THEME_CONDITIONS_DAY: colours.DARK_PINK,
    THEME_CONDITIONS_HUMIDITY: colours.LIGHT_CYAN,
    THEME_CONDITIONS_WIND: colours.PALE_TURQUOISE,
    THEME_CONDITIONS_SUNRISE: colours.PEACH,
    THEME_CONDITIONS_SUNSET: colours.ORANGE,
    THEME_CONDITIONS_DESCRIPTION: colours.WHITE_SMOKE,
}
...
THEME_MONOCHROME = {
    ...
    THEME_CONDITIONS_TIME: colours.WHITE_SMOKE,
    THEME_CONDITIONS_DATE: colours.GHOST_WHITE,
    THEME_CONDITIONS_DAY: colours.FLORAL_WHITE,
    THEME_CONDITIONS_HUMIDITY: colours.ALICE_BLUE,
    THEME_CONDITIONS_WIND: colours.WHITE,
    THEME_CONDITIONS_SUNRISE: colours.NAVAJO_WHITE,
    THEME_CONDITIONS_SUNSET: colours.ANTIQUE_WHITE,
    THEME_CONDITIONS_DESCRIPTION: colours.WHITE_SMOKE,
}
...
THEME_PASTEL = {
    ...
    THEME_FORECAST_TIME_AMPM: colours.DARK_BLUE,
    THEME_CONDITIONS_TIME: colours.BLUE_CALM,
    THEME_CONDITIONS_DATE: colours.LEMON_CHIFFON,
    THEME_CONDITIONS_DAY: colours.LIGHT_CYAN,
    THEME_CONDITIONS_HUMIDITY: colours.LIGHT_SKY_BLUE,
    THEME_CONDITIONS_WIND: colours.PALE_TURQUOISE,
    THEME_CONDITIONS_SUNRISE: colours.PEACH_PUFF,
    THEME_CONDITIONS_SUNSET: colours.LIGHT_SALMON,
    THEME_CONDITIONS_DESCRIPTION: colours.LEMON_CHIFFON,
}
...
THEME_CLASSIC = {
    ...
    THEME_FORECAST_TIME_AMPM: colours.DARK_BLUE,
    THEME_CONDITIONS_TIME: colours.BLUE_CALM,
    THEME_CONDITIONS_DATE: colours.PINK_DARKER,
    THEME_CONDITIONS_DAY: colours.PINK_DARK,
    THEME_CONDITIONS_HUMIDITY: colours.BLUE_LIGHT,
    THEME_CONDITIONS_WIND: colours.PALE_TURQUOISE,
    THEME_CONDITIONS_SUNRISE: colours.PEACH,
    THEME_CONDITIONS_SUNSET: colours.ORANGE,
    THEME_CONDITIONS_DESCRIPTION: colours.WHITE_SMOKE,
